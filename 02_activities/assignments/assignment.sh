...
rm data/processed/server_logs/*ipaddr*.log
rm data/processed/event_logs/*ipaddr*.log
rm data/processed/server_logs/*ipaddr*.txt
rm data/processed/user_logs/*ipaddr*.txt
rm data/processed/event_logs/*ipaddr*.txt
